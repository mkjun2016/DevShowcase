        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-lg">
              I create intuitive and performant applications with modern technologies. 
              Focused on building products that are accessible, inclusive, and user-friendly.
            </p>
          ...
          >
            <div className="relative w-full max-w-md">
              <img
                src="https://images.unsplash.com/photo-1618477388954-7852f32655ec?ixlib=rb-4.0.3&auto=format&fit=crop&q=80&w=500&h=500"
              ...
              <div className="absolute -top-4 -right-4 md:top-0 md:-right-12 bg-white dark:bg-gray-800 rounded-lg p-4 shadow-lg animate-float">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-10 w-10 text-blue-500">
              ...
              <div className="absolute -bottom-4 -left-4 md:-bottom-8 md:-left-12 bg-white dark:bg-gray-800 rounded-lg p-4 shadow-lg animate-float-delay-1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-10 w-10 text-yellow-500">
                  <g fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M4 7h16" />
                    <path d="M4 12h16" />
                    <path d="M4 17h16" />
              ...
              <div className="absolute top-1/2 -translate-y-1/2 -right-4 md:-right-16 bg-white dark:bg-gray-800 rounded-lg p-4 shadow-lg animate-float-delay-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-10 w-10 text-green-500">
                  <g fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
