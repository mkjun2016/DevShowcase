...
const skills = [
  ...
  { name: "MySQL & SQL", level: 30 },
  { name: "Python", level: 40 },
];

const tools = [
  { name: "React", icon: "ri-reactjs-line", color: "text-blue-500" },
  { name: "React Native", icon: "ri-nodejs-line", color: "text-green-500" },
  { name: "Node.js", icon: "ri-nodejs-line", color: "text-green-600" },
  { name: "MySQL", icon: "ri-database-2-line", color: "text-blue-600" },
  { name: "Git", icon: "ri-git-branch-line", color: "text-orange-600" },
  { name: "Zustand", icon: "ri-file-code-line", color: "text-purple-500" },
  {
    name: "Terminal",
    icon: "ri-terminal-box-line",
    color: "text-gray-600 dark:text-gray-400",
  },
  { name: "ReactQuery", icon: "ri-test-tube-line", color: "text-red-500" },
